                    ...
                    <div class="widget widget_about">
                        ...
                        <div class="logo-footer clearfix p-b15 text-center">
                            <a href="home" style="display: flex; padding:2px;">
                                <svg width="70px" height="70px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" style="margin-top: 10px;">
                                ...
                                <div style="padding-top:14px;letter-spacing: 3px; padding-left:10px;">
                                    <h4 class="text-uppercase text-white" style="font-weight:bold;line-height:13px;">cOINBASE</h4>
                                    <h4 class="text-uppercase text-white" style="font-weight:bold;line-height:13px;">INVEST</h4>
                                </div>
                            </a>
                        </div>
        ...
        <div class="container p-t30">
            <div class="row">
                <div class="wt-footer-bot-left">
                    <span class="copyrights-text">&copy; <?=date('Y')?> Your Company. All Rights Reserved. Designed By thewebmax.</span>
                </div>
