...
<body id="bg">
    ...
    <div class="page-wraper">
        ...
        <div class="page-content">
            ...
            <!-- INNER PAGE BANNER -->
            <div class="wt-bnr-inr overlay-wraper" style="background-image:url(<?=ROOT?>/images/banner/about-banner.jpg);">
            ...
            <div class="section-full p-tb100">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="wt-media">
                                <img src="<?=ROOT?>/images/gallery/pic3.jpg" alt="" class="img-responsive"/>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="section-content no-col-gap">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-6 animate_line">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    <div class="icon-lg text-primary m-b20">
                                        <a href="#" class="icon-cell"><img src="<?=ROOT?>/images/icon/pick-29.png" alt=""></a>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-6 animate_line">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    <div class="icon-lg text-primary m-b20">
                                        <a href="#" class="icon-cell"><img src="<?=ROOT?>/images/icon/pick-28.png" alt=""></a>
                                    </div>
                                    <div class="icon-content ">
                            ...
                            <div class="col-md-4 col-sm-6 animate_line">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    <div class="icon-lg text-primary m-b20">
                                        <a href="#" class="icon-cell"><img src="<?=ROOT?>/images/icon/pick-17.png" alt=""></a>
                                    </div>
                                    <div class="icon-content">
                            ...
                            <div class="col-md-4 col-sm-6 animate_line">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    <div class="icon-lg text-primary m-b20">
                                        <a href="#" class="icon-cell"><img src="<?=ROOT?>/images/icon/pick-19.png" alt=""></a>
                                    </div>
                                    <div class="icon-content">
                            ...
                            <div class="col-md-4 col-sm-6 animate_line">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    <div class="icon-lg text-primary m-b20">
                                        <a href="#" class="icon-cell"><img src="<?=ROOT?>/images/icon/pick-12.png" alt=""></a>
                                    </div>
                                    <div class="icon-content">
                            ...
                            <div class="col-md-4 col-sm-6 animate_line">
                                <div class="wt-icon-box-wraper  p-a30 center bg-white m-a5">
                                    <div class="icon-lg text-primary m-b20">
                                        <a href="#" class="icon-cell"><img src="<?=ROOT?>/images/icon/pick-38.png" alt=""></a>
                                    </div>
                                    <div class="icon-content">
                    ...
                    <div class="section-content">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4 m-tb15">
                                <div class="wt-team-one bg-white">
                                    <div class="wt-team-media">
                                        <a href="javascript:void(0);"><img src="<?=ROOT?>/images/our-team/pic1.jpg" alt=""></a>
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-4 m-tb15">
                                <div class="wt-team-one bg-white">
                                    <div class="wt-team-media ">
                                        <a href="javascript:void(0);"><img src="<?=ROOT?>/images/our-team/pic2.jpg" alt=""></a>
                                    </div>
                                    <div class="wt-team-info text-center bg-white p-a10">
                            ...
                            <div class="col-md-4 col-sm-4 m-tb15">
                                <div class="wt-team-one  bg-white">
                                    <div class="wt-team-media">
                                        <a href="javascript:void(0);"><img src="<?=ROOT?>/images/our-team/pic3.jpg" alt=""></a>
                                    </div>
                                    <div class="wt-team-info text-center bg-white p-a10">
